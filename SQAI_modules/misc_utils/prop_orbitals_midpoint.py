...
from .prop_orbitals import prop_orbitals


class prop_midpoint(prop_orbitals):
    def __init__(self, imaginary, dtime, basis, Laser=None, midpoint_type=0):
        super().__init__(imaginary=imaginary, dtime=dtime, basis=basis, Laser=Laser)
